...
export const SearchIcon = ({ color = "text-primary" }) => {
  return (
    <svg
...
export function GithubIcon({ color = "text-primary" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function RedoIcon({ color = "text-primary" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${color}`}>
      <path
        fill="currentColor"
